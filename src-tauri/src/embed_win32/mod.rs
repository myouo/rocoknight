...
mod win {
    ...
    use windows::Win32::UI::WindowsAndMessaging::{
        ...
        GWL_STYLE, GW_OWNER, HWND_TOP, SWP_FRAMECHANGED, SWP_NOMOVE, SWP_NOSIZE, SWP_NOZORDER,
        SWP_SHOWWINDOW, SW_HIDE, WS_CHILD, WS_MAXIMIZEBOX, WS_OVERLAPPEDWINDOW, WS_POPUP,
